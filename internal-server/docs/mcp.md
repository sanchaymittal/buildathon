...
- `deploy_replace`: Delete prior repo+user deployment and deploy again. Returns a ticket immediately (`status=building`). Optional `github_token` for private repos.
